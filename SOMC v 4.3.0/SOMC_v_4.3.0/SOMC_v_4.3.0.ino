...
void data_out() {
  if (printtime >= 100) {
    ...
    Serial.print(rec_count, DEC); Serial.print(",");
    Serial.print(pos1, DEC); Serial.print(",");
    Serial.print(pos2, DEC); Serial.print(",");
    Serial.print(pos3, DEC); Serial.print(",");
    Serial.print(pos4, DEC); Serial.print(",");

    Serial.print(m1Speed, DEC); Serial.print(",");
    Serial.print(m2Speed, DEC); Serial.print(",");
    Serial.print(m3Speed, DEC); Serial.print(",");
    Serial.print(m4Speed, DEC); Serial.print(",");
